...
<div class="story-screen">
  <div class="content-wrap">
    <div class="flex flex-col gap-8">
      <h2 class="heading-sm">How It Began</h2>
      <p class="body-text">
        {@html highlightAll (profile.bio_1)}
      </p>
    </div>
  </div>
</div>
                ...
                <div class="theme-row">
                  ...
                  <div class="jm-content-row">
                    ...
                    {#if avg != null}
                      ...
                      border: 1px solid {sentimentToColor(avg)};">
      ...
      {:else if screen === 'bio2'}
        <div class="story-screen">
          <div class="content-wrap">
            ...
            <p class="text-body">        
              {@html highlightAll(profile.bio_2)}
            </p>
          </div>
        </div>
