<script lang="ts">
    ...
    import Check from "phosphor-icons-svelte/IconCheckBold.svelte";
    import ChevronDown from 'phosphor-icons-svelte/IconTagChevronBold.svelte';
    import ChevronUp from 'phosphor-icons-svelte/IconTagChevronDuotone.svelte';
