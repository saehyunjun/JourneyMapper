<script>
  ...
  $: accentBg    = direction === 'positive' ? 'rgba(35,171,171,0.08)' : 'rgba(224,92,92,0.08)';
  ...
  <div class="content-wrap">
    ...
    <div class="step-header">
      <div class="flex flex-row align-middle gap-2">
        <IconArrowsOutLineVerticalRegular class="h-3"/>
    ...
    <!-- ── Path switcher tabs ─────────────────────────────────────────── -->
    <div class="flex flex-row gap-2" role="tablist">
      <button
    ...
    <!-- ── Active path detail ─────────────────────────────────────────── -->
    {#if activePath}
      <div class="path-card" style="border-color:{accentColor}44; background:{accentBg};">

        <!-- Direction badge -->
        <span class="direction-tag" style="color:{accentColor}; background:{accentColor}18;">
    ...
    <div class="emotion-row">
      ...
      <div class="jm-content-col">
        ...
        <div class="flex flex-row items-center gap-2 mt-1">
          ...
          <span class="label" style="color:{sentimentToColor(step.sentiment)}">
