/**
 * Segment-tag confirmation — POST endpoint.
 *
 * The upload review page's tag drawer posts one segment's tags here; they are
 * validated against codebook.json and upserted into segment_tags.json as a
 * confirmed, human-sourced annotation. Returns the stored annotation.
 */
import { json } from '@sveltejs/kit';
import type { RequestHandler } from './$types';
import { upsertAnnotation } from '$lib/server/segment-tags';
