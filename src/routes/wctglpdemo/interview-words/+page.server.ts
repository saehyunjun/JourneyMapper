/**
 * Interview-words page — loads the analyst-starred quote ids (for the key
 * quotes section) and every participant's profile (for the participant drawer)
 * so both render in the right state on first paint.
 */
